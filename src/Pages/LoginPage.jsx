...
const LoginPage = () => {
  return (
    <div className="bg-[#005881] h-screen w-full flex items-center justify-center">
      ...
      >
        <div className="w-2/5 bg-[#19516A] rounded-2xl px-5 mb-10 shadow-2xl shadow-zinc-900 flex flex-col justify-center items-center">
        ...
        <div className="text-white text-lg">
          <button className="bg-[#054161] px-5 py-2 w-72 rounded-md border-2 border-[#82A0B0] active:scale-105 duration-100">
            Login
          </button>
        </div>
      </div>
